...
public class TestData {
	...
	public static void CreateTestData(ContentResolver cr) {
		...
		Photo photo1 = new Photo("ad226e5caaf0880d8a3060e6", Users.getUser().getUserId(), "ad226e5caaf0880d8a3060e7", new LatLng(43.469475, -80.553280), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5135/5408239435_feb2da1f00_z_d.jpg";
		Photo photo2 = new Photo("b78c64155df03a3fae291ca8", Users.getUser().getUserId(), "ad226e5caaf0880d8a3060e7", new LatLng(43.469788, -80.552990), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5056/5408850774_226b5ce3ef_z_d.jpg";
		Photo photo3 = new Photo("ff7f35624cacd9b84cb4e161", Users.getUser().getUserId(), "ad226e5caaf0880d8a3060e7", new LatLng(43.469711, -80.553501), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		
		url = "https://farm6.staticflickr.com/5011/5491298842_c999a63b79_z_d.jpg";
		Photo photo4 = new Photo("ad226e5caaf0880d8a3060a6", Users.getUser().getUserId(), "ad226e5caaf0880d8a3061a6", new LatLng(43.470565, -80.552827), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5243/5370780817_4051c42430_z_d.jpg";
		Photo photo5 = new Photo("ad226e5caaf0880d8a3060e7", Users.getUser().getUserId(), "ad226e5caaf0880d8a3061a6", new LatLng(43.470618, -80.552487), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5288/5370785337_dd03dc2781_z_d.jpg";
		Photo photo6 = new Photo("ab226e5caaf0880d8a3060e6", Users.getUser().getUserId(), "ad226e5caaf0880d8a3061a6", new LatLng(43.470764, -80.552839), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5254/5505389616_088859ddfb_z_d.jpg";
		Photo photo7 = new Photo("ad226e6caaf0880d8a3060e6", Users.getUser().getUserId(), "ad226e5caaf0880d8a3061a6", new LatLng(43.470633, -80.553063), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		
		url = "https://farm6.staticflickr.com/5176/5407140650_93a14bf958_z_d.jpg";
		Photo photo8 = new Photo("e4d9a23aab8aae062efd1dca", Users.getUser().getUserId(), "e5d9a23aab8aae062efd1dca", new LatLng(43.471283, -80.551040), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5243/5371330214_1aec38fb5c_z_d.jpg";
		Photo photo9 = new Photo("e5d9a23aab8aae062efd1dca", Users.getUser().getUserId(), "e5d9a23aab8aae062efd1dca", new LatLng(43.471306, -80.551110), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5136/5511046696_851e6bd7d8_z_d.jpg";
		Photo photo10 = new Photo("e6d9a23aab8aae062efd1dca", Users.getUser().getUserId(), "e5d9a23aab8aae062efd1dca", new LatLng(43.470952, -80.551123), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});
		url = "https://farm6.staticflickr.com/5044/5370734053_51d70c7368_z_d.jpg";
		Photo photo11 = new Photo("e7d9a23aab8aae062efd1dca", Users.getUser().getUserId(), "e5d9a23aab8aae062efd1dca", new LatLng(43.471046, -80.550993), new Date(), new String[] {url, url, url}, new ArrayList<String>(), new String[] {"0", "0"});	
